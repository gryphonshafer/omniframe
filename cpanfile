...
requires 'Log::Dispatch::Email::Mailer', '1.15';
...
requires 'exact::conf', '1.10';
requires 'exact::lib', '1.05';
recommends 'IO::Socket::SSL', '2.098';
